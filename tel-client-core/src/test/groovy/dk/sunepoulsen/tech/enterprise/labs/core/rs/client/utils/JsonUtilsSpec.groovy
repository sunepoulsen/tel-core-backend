...
class JsonUtilsSpec extends Specification {
    ...
    void "Encode #_datatype as json"() {
        ...
        where:
            ...
            [prop: 'string']                           | 'String'        | '{"prop":"string"}'
            [prop: true]                               | 'Boolean'       | '{"prop":true}'
            [prop: 45]                                 | 'Integer'       | '{"prop":45}'
            [prop: 45L]                                | 'Long'          | '{"prop":45}'
            [prop: 3.257488563254]                     | 'Double'        | '{"prop":3.257488563254}'
            [prop: BigInteger.valueOf(45L)]            | 'BigInteger'    | '{"prop":45}'
            [prop: BigDecimal.valueOf(3.257488563254)] | 'BigDecimal'    | '{"prop":3.257488563254}'
            [prop: LOCAL_DATE]                         | 'LocalDate'     | '{"prop":"2021-01-20"}'
            [prop: LOCAL_TIME]                         | 'LocalTime'     | '{"prop":"12:04:12"}'
            [prop: LOCAL_DATE_TIME]                    | 'LocalDateTime' | '{"prop":"2021-01-20T12:04:12"}'
            [prop: ZONED_DATE_TIME]                    | 'ZonedDateTime' | '{"prop":"2021-01-20T12:04:12Z"}'
    }
    ...
    void "Encode static shortcut"() {
        expect:
            JsonUtils.encodeAsJson([prop: 'string']) == '{"prop":"string"}'
    }

    void "Decode static shortcut"() {
        expect:
            JsonUtils.decodeJson('{"text":"string"}', JsonTestModel) == new JsonTestModel(text: 'string')
    }
}
